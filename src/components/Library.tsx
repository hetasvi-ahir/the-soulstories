    ...
    <div className="space-y-4 mb-12">
      <div className="flex items-center justify-between px-2">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-sm font-black text-[#36251d] uppercase tracking-[0.2em]">Books suggested by others</h2>
        </div>
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-center gap-3 px-2 mb-6">
        ...
        <h2 className="text-sm font-black text-[#36251d] uppercase tracking-[0.2em]">Books in your library</h2>
      </div>
